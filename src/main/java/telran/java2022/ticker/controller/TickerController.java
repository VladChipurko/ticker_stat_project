...
public class TickerController {
	...
	public StatDto findStatistic(@PathVariable String name, @PathVariable long periodDays, @PathVariable double sum,
	...
	public double correlation(@PathVariable String name1, @PathVariable String name2,
